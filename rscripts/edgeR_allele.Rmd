...
divided.counts<-divided.counts[,allelic_sampleInfo$unique_name]


y <- DGEList(counts = divided.counts, samples = allelic_sampleInfo, group = allelic_sampleInfo$allele, genes = data$annotation)
