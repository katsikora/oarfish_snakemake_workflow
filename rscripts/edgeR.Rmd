...
#dirs<-list.dirs("/data/processing/bioinfo-core/oarfish_output",full.names=TRUE,recursive=TRUE)
#dirs<-dirs[!grepl("logs",dirs)]
#dirs<-dirs[!grepl("wasabi_sleuth",dirs)]
#dirs<-dirs[!grepl("aux_info",dirs)]
